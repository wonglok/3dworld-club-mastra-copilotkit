    ...
    <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-2xl w-full">
      ...
      <div className="flex flex-col gap-3 relative">
        <div className="h-full overflow-scroll">
          ...
          {state?.proverbs?.map((proverbObject, index) => {
            let proverb = proverbObject.verse;
            console.log(proverbObject);
            return (
              <div
                key={index}
              ...
              >
                <p className="pr-8">{proverbObject.verse}</p>
                <p className="pr-8">{proverbObject.text}</p>
                      ...
                      agent?.runAgent({}).then(() => {
                        let newState = {
                          ...
                          proverbs: state.proverbs?.filter(
                            (_, index) => _.verse !== proverbObject.verse,
                          ),
                        };
                        setState(newState);
